    ...
    def socks5(self, app_socket):
        ...
        # client sends a version identifier/method selection message
            ...
            if address_type == 1:  # IPv4
                ...
                addr = int.from_bytes(socket.inet_pton(socket.AF_INET, address), 'big', signed=False)
                ...
                addr = int.from_bytes(socket.inet_pton(socket.AF_INET6, address), 'big', signed=False)
